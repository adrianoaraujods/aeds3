...
export class ByteFile<TSchema extends z.ZodObject> {
  ...
  public insert(
    ...
    try {
      ...
      while (offset < buffer.length) {
        ...
        const isValid = buffer.readUInt8(offset) === 1;
        offset += 1;
        ...
        if (isValid) {
          const { value } = deserialize(buffer, offset, this.schema);
  ...
  public update(
    ...
    try {
      ...
      buffer.writeUInt8(0, isValidByteOffset);
